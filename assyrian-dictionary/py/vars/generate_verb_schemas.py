...
def generate_t1_verb_conj(is_haweh):
    ...
    ex_instance_noun = (
        "drive"  # not always the same as present/future, ex. invitation, speech
    )
    ...
    T1_VERB_CONJ = {
        ...
        "pastTense": {
            ...
            "rows": [
                ...
                {
                    "left": "you (to a man)",
                    "right": [{"value": "past-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "past-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "past-2nd-p", "type": "arg"}],
                },
        ...
        "presentTense": {
            ...
            "rows": [
                ...
                {
                    "left": "I (woman)",
                    "right": [{"value": "pres-1st-sf", "type": "arg"}],
                },
                {"left": "we", "right": [{"value": "pres-1st-p", "type": "arg"}]},
                {
                    "left": "you (to a man)",
                    "right": [{"value": "pres-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "pres-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "pres-2nd-p", "type": "arg"}],
                },
        ...
        "presentFutureTense": {
            ...
            "right_heading": [
                "Modal Construction",
                f'{ex_marker} i should "{ex_present_future}"',
            ],
            "rows": [
                {"left": "I (man)", "right": [{"value": "pres-1st-sm", "type": "arg"}]},
                {
        ...
        "imperativeMood": {
            ...
            "rows": [
                {
                    "left": "you (to a man)",
                    "right": [{"value": "imp-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "imp-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "imp-2nd-p", "type": "arg"}],
                },
            ],
        },
        "passivePastTense": {
            ...
            "rows": [
                {
                    "left": "I (man)",
                    "right": [{"value": "passive-past-1st-sm", "type": "arg"}],
                },
                {
                    "left": "I (woman)",
                    "right": [{"value": "passive-past-1st-sf", "type": "arg"}],
                },
                {
                    "left": "we",
                    "right": [{"value": "passive-past-1st-p", "type": "arg"}],
                },
                {
                    "left": "you (to a man)",
                    "right": [{"value": "passive-past-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "passive-past-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "passive-past-2nd-p", "type": "arg"}],
                },
                {
                    "left": "he",
                    "right": [{"value": "passive-past-3rd-sm", "type": "arg"}],
                },
                {
                    "left": "she",
                    "right": [{"value": "passive-past-3rd-sf", "type": "arg"}],
                },
                {
                    "left": "they",
                    "right": [{"value": "passive-past-3rd-p", "type": "arg"}],
                },
            ],
        },
        "copula": {
            ...
            "rows": [
                ...
                {
                    "left": "I (woman)",
                    "right": [{"value": "cop-1st-sf", "type": "arg"}],
                },
                {"left": "we", "right": [{"value": "cop-1st-p", "type": "arg"}]},
                {
                    "left": "you (to a man)",
                    "right": [{"value": "cop-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "cop-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "cop-2nd-p", "type": "arg"}],
                },
        ...
        "futureTense": {
            ...
            "rows": [
                ...
                {
                    "left": "I (woman)",
                    "right": [{"value": "fut-1st-sf", "type": "arg"}],
                },
                {"left": "we", "right": [{"value": "fut-1st-p", "type": "arg"}]},
                {
                    "left": "you (to a man)",
                    "right": [{"value": "fut-2nd-sm", "type": "arg"}],
                },
                {
                    "left": "you (to a woman)",
                    "right": [{"value": "fut-2nd-sf", "type": "arg"}],
                },
                {
                    "left": "you (to a group)",
                    "right": [{"value": "fut-2nd-p", "type": "arg"}],
                },
            ...
            "rows": [
                {
                    ...
                    "right": [{"value": "an-sm", "type": "arg"}],
                },
                {
                    "left": "singular feminine",
                    "right": [{"value": "an-sf", "type": "arg"}],
                },
                {
                    "left": "plural masculine",
                    "right": [{"value": "an-pm", "type": "arg"}],
                },
                {
                    "left": "plural feminine",
                    "right": [{"value": "an-pf", "type": "arg"}],
                },
            ],
        },
        "instanceNoun": {
    ...
    T1_VERB_CONJ["presentParticiple"]["children"] = [
        build_child(
            ...
            lambda abbr, _: [
                PRP_ARG,
                {
                    "value": conj_schema["aii-conj-haweh"]["parameters"][f"cop-{abbr}"],
                    "type": "literal",
                },
            ],
        ),
        ...
        build_child(
            ...
            lambda abbr, _: [
                {
                    "value": conj_schema["aii-conj-haweh"]["parameters"][f"fut-{abbr}"],
                    "type": "literal",
                },
                PRP_ARG,
            ],
    ...
    T1_VERB_CONJ["agentNoun"]["children"] = [
        ...
        build_child(
            ...
            lambda abbr, pp: [
                {
                    "value": conj_schema["aii-conj-haweh"]["parameters"][
                        f"pres-{abbr}"
                    ],
                    "type": "literal",
                },
