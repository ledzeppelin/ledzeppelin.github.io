...
conj_schema = {
    ...
    'aii-conj-verb/C-weak-2d-3i': {
        'prp': 'ܡܲ{{{1}}}ܘܿܝܹܐ',
        'pp-sm': 'ܡܘܼ{{{1}}}ܝܵܐ',
        'pp-sf': 'ܡܘܼ{{{1}}}ܲܝܬܵܐ',
        'pp-p': 'ܡܘܼ{{{1}}}ܝܹ̈ܐ',
        'passive-past-1st-sm': 'ܡܘܼ{{{1}}}ܹܝܢ',
        'passive-past-2nd-sm': 'ܡܘܼ{{{1}}}ܹܝܬ',
        'passive-past-3rd-sm': 'ܡܘܼ{{{1}}}ܹܐ',
        'passive-past-1st-p': 'ܡܘܼ{{{1}}}ܹܝܚ',
        'passive-past-2nd-p': 'ܡܘܼ{{{1}}}ܹܝܬܘܿܢ',
        'passive-past-3rd-p': 'ܡܘܼ{{{1}}}ܲܝ',
        'passive-past-1st-sf': 'ܡܘܼ{{{1}}}ܝܲܢ',
        'passive-past-2nd-sf': 'ܡܘܼ{{{1}}}ܝܲܬܝ',
        'passive-past-3rd-sf': 'ܡܘܼ{{{1}}}ܝܵܐ',
        ...
        'pres-1st-sm': 'ܡܲ{{{1}}}ܹܝܢ',
        'pres-1st-sf': 'ܡܲ{{{1}}}ܝܵܢ',
        'pres-2nd-sm': 'ܡܲ{{{1}}}ܹܝܬ',
        'pres-2nd-sf': 'ܡܲ{{{1}}}ܝܵܬܝ',
        'pres-3rd-sm': 'ܡܲ{{{1}}}ܹܐ',
        'pres-3rd-sf': 'ܡܲ{{{1}}}ܝܵܐ',
        'pres-1st-p': 'ܡܲ{{{1}}}ܲܚ',
        'pres-2nd-p': 'ܡܲ{{{1}}}ܝܼܬܘܿܢ',
        'pres-3rd-p': 'ܡܲ{{{1}}}ܝܼ',
        'imp-2nd-sm': 'ܐܲ{{{1}}}ܝܼ',
        'imp-2nd-sf': 'ܐܲ{{{1}}}ܹܐ',
        'imp-2nd-p': 'ܐܲ{{{1}}}ܹܝܡܘܼܢ',
        'an-sm': 'ܡܲ{{{1}}}ܝܵܢܵܐ',
        'an-sf': 'ܡܲ{{{1}}}ܝܵܢܝܼܬ݂ܵܐ',
        'an-pm': 'ܡܲ{{{1}}}ܝܵܢܹ̈ܐ',
        'an-pf': 'ܡܲ{{{1}}}ܝܵܢ̈ܝܵܬ݂ܵܐ',
        'in-s': 'ܡܲ{{{1}}}ܲܝܬܵܐ',
        'in-p': 'ܡܲ{{{1}}}ܲܝ̈ܵܬ݂ܵܐ',
    },
    'aii-conj-verb/C-weak-3i': {
        'prp': 'ܡܲ{{{1}}}{{{2}}}ܘܿܝܹܐ',
        'pp-sm': 'ܡܘܼ{{{1}}}{{{2}}}ܝܵܐ',
        'pp-sf': 'ܡܘܼ{{{1}}}{{{2}}}ܲܝܬܵܐ',
        'pp-p': 'ܡܘܼ{{{1}}}{{{2}}}ܝܹ̈ܐ',
        'passive-past-1st-sm': 'ܡܘܼ{{{1}}}{{{2}}}ܹܝܢ',
        'passive-past-2nd-sm': 'ܡܘܼ{{{1}}}{{{2}}}ܹܝܬ',
        'passive-past-3rd-sm': 'ܡܘܼ{{{1}}}{{{2}}}ܹܐ',
        'passive-past-1st-p': 'ܡܘܼ{{{1}}}{{{2}}}ܹܝܚ',
        'passive-past-2nd-p': 'ܡܘܼ{{{1}}}{{{2}}}ܹܝܬܘܿܢ',
        'passive-past-3rd-p': 'ܡܘܼ{{{1}}}{{{2}}}ܲܝ',
        'passive-past-1st-sf': 'ܡܘܼ{{{1}}}{{{2}}}ܝܲܢ',
        'passive-past-2nd-sf': 'ܡܘܼ{{{1}}}{{{2}}}ܝܲܬܝ',
        'passive-past-3rd-sf': 'ܡܘܼ{{{1}}}{{{2}}}ܝܵܐ',
        ...
        'imp-2nd-sf': 'ܐܲ{{{1}}}{{{2}}}ܲܝ',
        'imp-2nd-p': 'ܐܲ{{{1}}}{{{2}}}ܲܘ',
        'an-sm': 'ܡܲ{{{1}}}{{{2}}}ܝܵܢܵܐ',
        'an-sf': 'ܡܲ{{{1}}}{{{2}}}ܝܵܢܝܼܬ݂ܵܐ',
        'an-pm': 'ܡܲ{{{1}}}{{{2}}}ܝܵܢܹ̈ܐ',
        'an-pf': 'ܡܲ{{{1}}}{{{2}}}ܝܵܢ̈ܝܵܬ݂ܵܐ',
        'in-s': 'ܡܲ{{{1}}}{{{2}}}ܲܝܬܵܐ',
        'in-p': 'ܡܲ{{{1}}}̈{{{2}}}ܲܝܵܬ݂ܵܐ',
    },
    'aii-conj-verb/C-weak-d': {
        'prp': 'ܡܲ{{{1}}}ܘܿ{{{2}}}ܹܐ',
        'pp-sm': 'ܡܘܼ{{{1}}}{{{2}}}ܵܐ',
        'pp-sf': 'ܡܘܼ{{{1}}}ܲ{{{2}}}ܬܵܐ',
        'pp-p': 'ܡܘܼ{{{1}}}{{{2}}}ܹ̈ܐ',
    ...
    'aii-conj-verb/C-weak-m': {
        'prp': 'ܡܲ{{{1}}}ܝܘܿ{{{2}}}ܹܐ',
        'pp-sm': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܵܐ',
        'pp-sf': 'ܡܘܼ{{{1}}}ܝܲ{{{2}}}ܬܵܐ',
        'pp-p': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܹ̈ܐ',
        'passive-past-1st-sm': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܸܢ',
        'passive-past-2nd-sm': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܸܬ',
        'passive-past-3rd-sm': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}}',
        'passive-past-1st-p': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܸܚ',
        'passive-past-2nd-p': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܝܼܬܘܿܢ',
        'passive-past-3rd-p': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܝܼ',
        'passive-past-1st-sf': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܲܢ',
        'passive-past-2nd-sf': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܲܬܝ',
        'passive-past-3rd-sf': 'ܡܘܼ{{{1}}}ܝ{{{2}}}ܵܐ',
        'past-1st-s': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܝܼ',
        'past-2nd-sm': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܘܼܟ݂',
        'past-2nd-sf': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܵܟ݂ܝ',
        'past-3rd-sm': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܹܗ',
        'past-3rd-sf': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܵܗ̇',
        'past-1st-p': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܲܢ',
        'past-2nd-p': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܵܘܟ݂ܘܿܢ',
        'past-3rd-p': 'ܡܘܼ{{{1}}}ܝܸ{{{2}}} ܠܗܘܿܢ',
        ...
        'an-sm': 'ܡܲ{{{1}}}ܝ{{{2}}}ܵܢܵܐ',
        'an-sf': 'ܡܲ{{{1}}}ܝ{{{2}}}ܵܢܝܼܬ݂ܵܐ',
        'an-pm': 'ܡܲ{{{1}}}ܝ{{{2}}}ܵܢܹ̈ܐ',
        'an-pf': 'ܡܲ{{{1}}}ܝ{{{2}}}ܵܢܝܵܬ݂̈ܵܐ',
        'in-s': 'ܡܲ{{{1}}}ܝܲ{{{2}}}ܬܵܐ',
    ...
    'aii-conj-verb/D-weak-3i': {
        'prp': 'ܡ{{{1}}}ܲ{{{2}}}ܘܿܝܹܐ',
        'pp-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}ܝܵܐ',
        'pp-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}ܲܝܬܵܐ',
        'pp-p': 'ܡ{{{1}}}ܘܼ{{{2}}}ܝܹ̈ܐ',
        'passive-past-1st-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}ܹܝܢ',
        'passive-past-2nd-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}ܹܝܬ',
        'passive-past-3rd-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}ܹܐ',
        'passive-past-1st-p': 'ܡ{{{1}}}ܘܼ{{{2}}}ܹܝܚ',
        'passive-past-2nd-p': 'ܡ{{{1}}}ܘܼ{{{2}}}ܹܝܬܘܿܢ',
        'passive-past-3rd-p': 'ܡ{{{1}}}ܘܼ{{{2}}}ܲܝ',
        'passive-past-1st-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}ܝܲܢ',
        'passive-past-2nd-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}ܝܲܬܝ',
        'passive-past-3rd-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}ܝܵܐ',
        ...
        'imp-2nd-p': '{{{1}}}ܲ{{{2}}}ܲܘ',
        'an-sm': 'ܡ{{{1}}}ܲ{{{2}}}ܝܵܢܵܐ',
        'an-sf': 'ܡ{{{1}}}ܲ{{{2}}}ܝܵܢܝܼܬ݂ܵܐ',
        'an-pm': 'ܡ{{{1}}}ܲ{{{2}}}ܝܵܢܹ̈ܐ',
        'an-pf': 'ܡ{{{1}}}ܲ{{{2}}}ܝܵܢ̈ܝܵܬ݂ܵܐ',
        'vn': '{{{1}}}ܘܼ{{{2}}}ܵܝܵܐ',
        'in-s': '{{{1}}}ܲ{{{2}}}ܲܝܬܵܐ',
        'in-p': '{{{1}}}ܲ{{{2}}}ܲܝ̈ܵܬ݂ܵܐ',
    },
    ...
    'aii-conj-verb/G-weak-2i': {
        'prp': '{{{1}}}ܝܵ{{{2}}}ܵܐ',
        'pp-sm': '{{{1}}}ܝܼ{{{2}}}ܵܐ',
        'pp-sf': '{{{1}}}ܝܼ{{{2}}}ܬܵܐ',
        'pp-p': '{{{1}}}ܝܼ{{{2}}}ܹ̈ܐ',
        'passive-past-1st-sm': '{{{1}}}ܝܼ{{{2}}}ܸܢ',
        'passive-past-2nd-sm': '{{{1}}}ܝܼ{{{2}}}ܸܬ',
        'passive-past-3rd-sm': '{{{1}}}ܝܼ{{{2}}}',
        'passive-past-1st-p': '{{{1}}}ܝܼ{{{2}}}ܸܚ',
        'passive-past-2nd-p': '{{{1}}}ܝܼ{{{2}}}ܝܼܬܘܿܢ',
        'passive-past-3rd-p': '{{{1}}}ܝܼ{{{2}}}ܝܼ',
        'passive-past-1st-sf': '{{{1}}}ܝܼ{{{2}}}ܲܢ',
        'passive-past-2nd-sf': '{{{1}}}ܝܼ{{{2}}}ܲܬܝ',
        'passive-past-3rd-sf': '{{{1}}}ܝܼ{{{2}}}ܵܐ',
        ...
        'an-sf': '{{{1}}}ܵܝܘܿ{{{2}}}ܬܵܐ',
        'an-pm': '{{{1}}}ܵܝܘܿ{{{2}}}ܹ̈ܐ',
        'an-pf': '{{{1}}}ܵܝܘܿ{{{2}}}ܝ̈ܵܬ݂ܵܐ',
        'vn': '{{{1}}}ܝܵ{{{2}}}ܵܐ',
        'in-s': '{{{1}}}ܝܵ{{{2}}}ܬܵܐ',
        'in-p': '{{{1}}}ܝܵ{{{2}}}ܝܵܬ݂̈ܵܐ',
    },
    'aii-conj-verb/G-weak-3i': {
        'prp': '{{{1}}}{{{2}}}ܵܝܵܐ',
        'pp-sm': '{{{1}}}ܸ{{{2}}}ܝܵܐ',
        'pp-sf': '{{{1}}}{{{2}}}ܝܼܬ݂ܵܐ',
        'pp-p': '{{{1}}}ܸ{{{2}}}ܝܹ̈ܐ',
        'passive-past-1st-sm': '{{{1}}}{{{2}}}ܹܝܢ',
        'passive-past-2nd-sm': '{{{1}}}{{{2}}}ܹܝܬ',
        'passive-past-3rd-sm': '{{{1}}}{{{2}}}ܹܐ',
        'passive-past-1st-p': '{{{1}}}{{{2}}}ܹܝܚ',
        'passive-past-2nd-p': '{{{1}}}{{{2}}}ܹܝܬܘܿܢ',
        'passive-past-3rd-p': '{{{1}}}{{{2}}}ܲܝ',
        'passive-past-1st-sf': '{{{1}}}ܸ{{{2}}}ܝܲܢ',
        'passive-past-2nd-sf': '{{{1}}}ܸ{{{2}}}ܝܲܬܝ',
        'passive-past-3rd-sf': '{{{1}}}ܸ{{{2}}}ܝܵܐ',
        ...
        'an-sf': '{{{1}}}ܵ{{{2}}}ܘܿܝܬܵܐ',
        'an-pm': '{{{1}}}ܵ{{{2}}}ܘܿܝܹ̈ܐ',
        'an-pf': '{{{1}}}ܵ{{{2}}}ܘܿܝ̈ܵܬ݂ܵܐ',
        'vn': '{{{1}}}{{{2}}}ܵܝܵܐ',
        'in-s': '{{{1}}}{{{2}}}ܵܝܬܵܐ',
        'in-p': '{{{1}}}̈{{{2}}}ܵܝܵܬ݂ܵܐ',
    },
    'aii-conj-verb/Gt-strong': {
    ...
    'aii-conj-verb/Q-weak': {
        'prp': 'ܡ{{{1}}}ܲ{{{2}}}{{{3}}}ܘܿܝܹܐ',
        'pp-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܝܵܐ',
        'pp-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܲܝܬܵܐ',
        'pp-p': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܝܹ̈ܐ',
        'passive-past-1st-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܹܝܢ',
        'passive-past-2nd-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܹܝܬ',
        'passive-past-3rd-sm': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܹܐ',
        'passive-past-1st-p': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܹܝܚ',
        'passive-past-2nd-p': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܹܝܬܘܿܢ',
        'passive-past-3rd-p': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܲܝ',
        'passive-past-1st-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܝܲܢ',
        'passive-past-2nd-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܝܲܬܝ',
        'passive-past-3rd-sf': 'ܡ{{{1}}}ܘܼ{{{2}}}{{{3}}}ܝܵܐ',
        ...
        'an-sm': 'ܡ{{{1}}}ܲ{{{2}}}{{{3}}}ܝܵܢܵܐ',
        'an-sf': 'ܡ{{{1}}}ܲ{{{2}}}{{{3}}}ܝܵܢܝܼܬ݂ܵܐ',
        'an-pm': 'ܡ{{{1}}}ܲ{{{2}}}{{{3}}}ܝܵܢܹ̈ܐ',
        'an-pf': 'ܡ{{{1}}}ܲ{{{2}}}{{{3}}}ܝܵܢܝܵܬ݂̈ܵܐ',
        'vn': '{{{1}}}ܘܼ{{{2}}}{{{3}}}ܵܝܵܐ',
        'in-s': '{{{1}}}ܲ{{{2}}}{{{3}}}ܲܝܬܵܐ',
        'in-p': '{{{1}}}ܲ{{{2}}}{{{3}}}ܲܝܵܬ݂̈ܵܐ',
    },
    'aii-conj-verb/Qi-strong': {
