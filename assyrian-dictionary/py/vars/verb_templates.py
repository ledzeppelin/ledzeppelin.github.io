...
conj_schema = {
    ...
    "c-weak-2": {
        ...
        "parameters": {
            ...
            "past-1st-s": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܝܼ",
            "past-2nd-sm": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܘܼܟ݂",
            "past-2nd-sf": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܵܟ݂ܝ",
            "past-3rd-sm": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܹܗ",
            "past-3rd-sf": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܵܗ̇",
            "past-1st-p": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܲܢ",
            "past-2nd-p": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܵܘܟ݂ܘܿܢ",
            "past-3rd-p": "ܡܘܼ{{{1}}}{{{ܝ}}}ܸ{{{2}}} ܠܗܘܿܢ",
            "pres-1st-sm": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܸܢ",
            "pres-1st-sf": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܲܢ",
            "pres-2nd-sm": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܸܬ",
            "pres-2nd-sf": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܵܬܝ",
            "pres-3rd-sm": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}",
            "pres-3rd-sf": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܵܐ",
            "pres-1st-p": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܲܚ",
            "pres-2nd-p": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܝܼܬܘܿܢ",
            "pres-3rd-p": "ܡܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܝܼ",
            "imp-2nd-sm": "ܐܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}",
            "imp-2nd-sf": "ܐܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܝ",
            "imp-2nd-p": "ܐܲ{{{1}}}{{{ܝ}}}ܸ{{{2}}}ܘܼܢ",
            "an-sm": "ܡܲ{{{1}}}{{{ܝ}}}{{{2}}}ܵܢܵܐ",
            "an-sf": "ܡܲ{{{1}}}{{{ܝ}}}{{{2}}}ܵܢܝܼܬ݂ܵܐ",
            "an-pm": "ܡܲ{{{1}}}{{{ܝ}}}{{{2}}}ܵܢܹ̈ܐ",
            "an-pf": "ܡܲ{{{1}}}{{{ܝ}}}{{{2}}}ܵܢܝܵܬ݂̈ܵܐ",
            "in-s": "ܡܲ{{{1}}}{{{ܝ}}}ܲ{{{2}}}ܬܵܐ",
            "in-p": "ܡܲ{{{1}}}{{{ܝ}}}ܲ{{{2}}}ܝܵܬ݂̈ܵܐ"
        }
    },
    "d-strong": {
        "is_radical_strong": [True, True, True],
